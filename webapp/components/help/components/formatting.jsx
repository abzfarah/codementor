...
export default class HelpFormatting extends React.Component {
    render() {
        ...
        message.push('```\n' + localizeMessage('help.formatting.imagesExample', '![alt text](link "hover text")\n\nand\n\n[![Build Status](https://travis-ci.org/mattermost/platform.svg?branch=master)](https://travis-ci.org/mattermost/platform) [![Github](https://assets-cdn.github.com/favicon.ico)](https://github.com/nomadsingles/platform)') + '\n```');
        message.push(localizeMessage('help.formatting.renders', 'Renders as:'));
